...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/alexandria/flexsearch.min.js');loadScript('/alexandria/en.search-data.min.20c7afa783e3204f0a98e631b498210211de818de7338c72ff5f425d5dc9181a.js',function(){input.required=false;search();});}
